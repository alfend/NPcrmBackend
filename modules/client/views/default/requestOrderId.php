            ...
            <div class="card-body">
                ...
                <div class="mb-3 accordion">
                    ...
                    <div class="ml-3 accordion__body">
                        <p class="font-weight-bold"><span class="color-light">Заказ:</span> № <?= $request['id'] ?></p>
                        <p class="font-weight-bold"><span class="color-light">Дата заказа:</span> <?= substr($request['date_create'],0,10) ?></p>
                        <p class="font-weight-bold"><span class="color-light">Время заказа:</span> <?= substr($request['date_create'],11,8) ?></p>
                ...
                <div class="mb-3 accordion">
                    <h4 class="color-primary text-uppercase accordion__header mb-1">информация по монтажной бригаде</h4>
                    <div class="ml-3 accordion__body">

                        <?php
                        if($worker['id']>0){
                            $work = $worker['lastname'].' '.$worker['firstname'];
                        } else {
                            $work = Html::a('Выбрать', ['/client/default/select-mounting'], [
                                'data-method' => 'POST',
                                'data-params' => [
                        ...
                        <p class="font-weight-bold"><span class="color-light">Назначен:</span><?= $work ?></p>
                        <p class="font-weight-bold"><span class="color-light">Телефон:</span> <a href="tel:88005052728">8 (800) 505-27-28</a> (доб. <?= $worker['id'] ?>)</p>
                    </div>
                </div>

                <div class="mb-3 accordion">
                    <h4 class="color-primary text-uppercase accordion__header mb-1">информация по стоимости</h4>
                    <div class="ml-3 accordion__body">
                        <p class="font-weight-bold"><span class="color-light">Стоимость заказа:</span> <?= $price ?></p>
                        <p class="font-weight-bold"><span class="color-light">Авансовый платеж:</span> <?= $prepayment ?></p>

                         <?php /*
                         print('<p class="font-weight-bold"><span class="color-light">Статус заказа:</span>');
                    ...
                    <hr class="hr">
                    <div class="card-number text-center"><b><?= $prepayment ?> ₽</b></div>
                    <hr class="hr">

                    <div class="mt-3 text-center">
                        <button type="submit" class="btn btn-primary">Оплатить авансовый платеж</button>
                    </div>
                </div>
