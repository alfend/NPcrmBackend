...
class RestController extends Controller
{
    ...
    public function actionRequestMeteringAll()
    {
        ...
        return $this->asJson($request_metering);
    }
    ...
    public function actionRequestMeteringId()
    {
        ...
        if($request_metering['id_client']==Yii::$app->user->getId()) {
           return $this->asJson([$request_metering,$count_workers,$worker,$data_metering]);
        }
    }

    //вывод замера
    public function actionRequestId()
    {
        $this->layout = '';
        $id_request = Yii::$app->request->get('id_request');;
        $request = new Request();
